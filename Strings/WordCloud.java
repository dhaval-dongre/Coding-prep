            ...
            for(String s : inputString.split("[\\s,;.?!:]+")){
                ...
                if(Character.isLetter(s.charAt(0))){
                    ...
                    if(wordsToCounts.containsKey(s))
                        wordsToCounts.put(s.toLowerCase(), wordsToCounts.get(s.toLowerCase())+1);
                    
                    else  if(wordsToCounts.containsKey(s.toLowerCase()))
                        wordsToCounts.put(s.toLowerCase(), wordsToCounts.get(s.toLowerCase())+1);
                    
                    
                    else if(wordsToCounts.containsKey(capitalize(s))){
                        wordsToCounts.put(s, wordsToCounts.get(capitalize(s))+1);
                        wordsToCounts.remove(capitalize(s));
                    }
