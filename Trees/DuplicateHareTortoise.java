...
public class Solution {
    ...
    public static int findDuplicate(int[] intArray) {
        ...
        int stickStart=intArray[0];
        int stickEnd=intArray[0];
        
        do{
            stickStart=intArray[stickStart];
            stickEnd=intArray[intArray[stickEnd]];
        }
        while(stickStart!=stickEnd);
        
        stickStart=intArray[0];
        
        while(stickStart!=stickEnd){
            stickStart=intArray[stickStart];
            stickEnd=intArray[stickEnd];
        }
